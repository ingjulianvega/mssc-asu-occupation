...
import ingjulianvega.ximic.occupation.configuration.OccupationParameters;
...
public class MvcExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public MvcExceptionHandler(OccupationParameters occupationParameters) {
        this.occupationParameters = occupationParameters;
    }

    OccupationParameters occupationParameters;


    @ExceptionHandler(OccupationException.class)
    public ResponseEntity<ApiError> validationErrorHandler(OccupationException ame) {
        ApiError apiError = ApiError
                .builder()
                .timestamp(LocalDateTime.now())
                .api(occupationParameters.getApi())
